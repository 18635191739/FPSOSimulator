...
namespace FPSOSimulator.Controls
{
    ...
    public partial class CButton : UserControl
    {
        ...
        {            
            ...
            _normalImage = Image.FromStream(Assembly.GetExecutingAssembly().GetManifestResourceStream(@"FirefightSystem.Res.Button.btnnomal.bmp"));
            _moveImage = Image.FromStream(Assembly.GetExecutingAssembly().GetManifestResourceStream(@"FirefightSystem.Res.Button.btnfore.bmp"));
            _downImage = Image.FromStream(Assembly.GetExecutingAssembly().GetManifestResourceStream(@"FirefightSystem.Res.Button.btndown.bmp"));
